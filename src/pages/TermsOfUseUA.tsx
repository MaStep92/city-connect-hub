        ...
        <div className="prose prose-lg max-w-none text-foreground">
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              Використовуючи мобільний застосунок SmartCity ("Застосунок"), ви погоджуєтесь дотримуватись цих Умов використання. Якщо ви не погоджуєтесь з цими умовами, будь ласка, не використовуйте Застосунок.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              SmartCity — це мобільний застосунок, який надає доступ до міських сервісів, включаючи, але не обмежуючись:
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              Усі права на Застосунок, включаючи дизайн, код, логотипи та контент, належать SmartCity або його ліцензіарам. Ви не маєте права копіювати, модифікувати чи розповсюджувати будь-яку частину Застосунку без нашого письмового дозволу.
            </p>
          </section>
